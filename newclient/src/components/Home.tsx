...
for (let i = 0; i < 10; i++) {
  modalDemo.push(
    <Button key={usa[i].name} id={usa[i].name} className="text-left" color="light" block>
      {usa[i].name}
      {Math.random() > 0.6 && <span className="float-right text-success">VISITED</span>}
    </Button>,
  );
}
  ...
  return (
    <>
      <div className="landing-div">
        <div className={landingDiv ? 'landing-div-inner div-enter' : 'landing-div-inner div-exit'}>
      ...
      <div className="map-div">
        <div className="map-div-inner grid md:grid-cols-2 grid-cols-1">
          ...
          <div>
            <img className="home-img" src={darkV10} alt="mapbox dark-v10 theme" />
            <h3>Dark V10</h3>
          </div>
          <div>
            <img className="home-img" src={lightV10} alt="mapbox light-v10 theme" />
            <h3>Light V10</h3>
          </div>
          <div>
            <img className="home-img" src={outdoorsV11} alt="mapbox outdoors-v11 theme" />
            <h3>Outdoors V11</h3>
          </div>
          <div>
            <img className="home-img" src={streetsV11} alt="mapbox streets-v11 theme" />
            <h3>Streets V11</h3>
          </div>
          <div className="md:col-span-2 sm:col-span-1">
            <img className="sat-img home-img" src={satelliteV9} alt="mapbox satellite-v9 theme" />
            <h3>Satellite V9</h3>
          </div>
        </div>
      </div>
